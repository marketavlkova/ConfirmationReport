...
After cloning a colony PCR using pUA66\textunderscore clon primers (Table \ref{pcr}) successfully amplified sequence of expected length (1.1 kb) in all 8 transformants tested (Fig. \ref{colonyPCR}).
