...
This is usually characterised by a rise-time, i.e. time when the concentration of a gene product reaches its half maximal concentration after gene induction.
...
It was predicted that coherent FFLs cause sign-sensitive delays in regulatory kinetics and incoherent FFLs should act as sign-sensitive accelelators \cite{mangan2003structure}.
...
The former motif (AND-FFL) thus prevents Z expression when concentration of X fluctuates close to a threshold, while the latter circuit (SUM-FFL) enables production of Z even if X concentration drops below a threshold for a while.
