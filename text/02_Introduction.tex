...
This suggests that the motifs' fundamental functions are preserved even when interconnected with other motifs.
Overall this type of regulation similarly to negative feedback loop shortens the rise-time, but unlike the negative feedback doesn't preserve overshoots rather the opposite.
