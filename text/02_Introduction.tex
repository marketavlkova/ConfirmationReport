...
As the neutral signal caffeine was added to media which yeast \tax{S. cerevisiae} was expect to associate with upcoming 5-fluoroorotic acid presence (metabolised into toxic substance).
...
More recent studies conclude on that as well \cite{barroso2017evolution}%%%, duveau2018fitness}. 
%%%Most of this work was done on a yeast \tax{Saccharomyces cerevisiae} \cite{metzger2015selection, duveau2018fitness} and \tax{E. coli} \cite{silander2012genome, wolf2015expression}.
%%%But some work on other eukaryotic model organisms such as \tax{Drosophila melanogaster} \cite{schor2017promoter} and mouse \cite{barroso2017evolution} has been done as well.
