...
% I've put in a couple of grammar / punctuation changes that are obvious or simple and not added a comment.
% I've put in a lot fo commas. Maybe I like them too much?
...
%%% I CHANGED IT. IS IT BETTER? OR DO YOU WANT MORE FLUENT TRANSITION?
% you might also talk about other direct inducers that are not metabolic, e.g. SOS/lexA/recA
%%% I MADE A MENTION OF lexA/recA ABOVE IN Cellular responses AND REFER TO IT A BIT IN THE FIRST SENTECE OF THIS SECTION. DO YOU STILL WANT ME TO DESCRIBE OTHER (NOT METABOLIC) DIRECT INDUCERS?

%% No, this is good. I like the "lactose...other metabolic stuff might be different..." transition.

% "molecular mechanisms differ", not "things might work the opposite"
...
%%% IS IT OK IF I DELETE THE WHOLE PARAGRAPH LIKE THIS?
...
% No, I think what you have no is fine. You have a brief introduction to each concept, which is nice.
...
%%% ADD MORE INFO AND/OR REFERENCES?
...
%%% THIS SHOULD BE MOVED INTO SECTION DEDICATED TO BACTERIAL MEMORY:
...
%%% DO YOU WANT ME TO DESCRIBE THOSE MORE IN DETAIL OR CAN I LEAVE IT JUST LIKE THAT?
% No, the detail is great, it might even be too much in some places...
...
% "has been shown" or "has been predicted"?
...
% I would start section 0.4 with feedback loops (so switch 0.4.2 and 0.4.1), as it follows naturally from the last bit of 0.3.2 Then you can mention methylation as *another* way besides TFs that epigenetic inheritance can occur, rather than making it the focus of the section.
...
% rarely are pictures *too* simple. This is good. Maybe label the lrp sites as you refer to them in the text?
\begin{figure}[h!]
  \centering
...
% see also https://www.nature.com/articles/nature1191
% http://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.1001928
