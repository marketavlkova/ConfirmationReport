...
The simplest one is repressor binding to the operator which overlaps one or both of those promoter elements.
Other promoters have distant operators outside -10 and -35 elements, but bound repressors cluster creating a DNA loop which also constitutes a blockage.
A more complex and indirect way of repression is by inhibiting activating transcription factors (described below) - i.e. repressors acting as anti-activators.
Because at some promoters the binding of activator is necessary for the transcription initiation, anti-activation is sufficient for complete repression.
...
Such promoter sequences have arrays of operators and the amount of bound repressors affect the strength of the repression.
