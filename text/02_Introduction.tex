...
Effects of feedback loops on both aspects i.e. transcription dynamics and memory are characterized in detail below.
...
This is so probably due to low initial amounts of the auto-inducer which might be either diluted before the expression is fully induced or bound to its other functions within the cell.
This stochasticity in auto-inducer binding to its promoter is likely to cause higher transcription noise upon the induction among individuals and delay it.
Although slower and noisier, this motif enables cells to react to much lower concentrations of a signal thanks to the positive feedback.
Both graded and hysteretic expression can occur in genes regulated this way \cite{maeda2006regulatory}.
