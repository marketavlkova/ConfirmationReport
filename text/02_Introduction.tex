...
Even when both global and specific regulation of transcription initiation permits transcript production the gene expression is still regulated further downstream e.g. during mRNA elongation or translation.
Moreover a transcription factor can regulate multiple genes as well as being co-regulated by several factors including itself.
Regulation of gene expression thus exhibit a huge network of mutually controlled output production based on the information acquired by a cell.
