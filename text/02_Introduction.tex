...
%%%Ability and capacity to evolve is important due to perpetually changing conditions bacteria are exposed to.
%%%And not only the conditions themselves, but also the duration of certain conditions, a particular bacterium is used to, can vary.
%%%The extent an individual is likely to accumulate beneficial mutations in defined condition is connected with its viability in that condition.
%%%The same beneficial mutation doesn't represent the same degree of improvement for two strains with similar genetic background but different fitness.
%%%A mutation that would have just a small impact on the fitter strain, have usually much bigger benefit for the other and thus is more likely to fix in the population.
%%%In this context the less fit an organism in the environment is the higher is its evolvability, which can be understood here as a potential to evolve.
%%%This has certain limits however, because when the strain's fitness is too low it's more likely going to extinct than to evolve depending on the population size.
%%% I'm not sure if I'm going to leave the paragraph or delete it...
