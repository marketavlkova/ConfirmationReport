...
% 17.9.2018
% you could give some intuition as to why you don't always want second-level reaction. e.g. if you don't want to produce a ton of protein for a response that is likely to be very transient.
...
In that case the cell fate depends on the proteins or other small molecules it has already synthesised, and when none with an appropriate enzymatic activity is present, the cell dies. % not always dies - often a cell just won't do as well as it *could* do, e.g. grow as fast, have a higher *chance* of dying, etc.
One example of a fast response to a signal is chemotaxis.
When a motile bacterium occurs in an attractant (e.g. nutrients such as sugars or amino acids) or repellent (toxic metabolites, some divalent cations) gradient, it swim towards or away from the higher concentration of it, respectively.
% 17.9.2018
...
% 17.9.2018
% I would say this is also good for cases in which responding immediately might hurt you e.g. if the responser is a huge physiological change and costs a lot of energy, it is not advantageous to respond all the time.
Transcriptional responses are adequate in slowly changing environments (e.g. decrease in preferred carbon source concentration).
...
To manage and orchestrate many responses to multiple signals cells evolved a network of extra- and intracellular signaling pathways.
...
% 17.9.2018
% what would you call UV or heat? Also direct?
...
Cells avoid wasteful production of proteins which are not used at all the time. % Reference?
% 17.9.2018
% well, if lactose might be there soon, there is some advantage to producing it, or a small amount at least
For instance, there is no sense in producing plenty of enzyme hydrolysing lactose (lacZ) if no lactose is present.
% 17.9.2018
% you should say something about why you are focusing on E. coli, either here or above?
To achieve this, \tax{E. coli} expresses \tax{lac} repressor (LacI) \cite{hudson1990co}.
% 17.9.2018
% "take a turn" is a bit too colloquial?
...
% 17.9.2018
% CRP - which does what...or reacts to what...
...
The histidine domain of a sensor protein serves here as a phosphate donor to an aspartate domain of the same or another protein.
...
Finally, the aspartate domain of a DNA-binding regulator receives phosphate from the third domain in row.
...
% 17.9.2018
% Thjs needs a better title, as above you have been talking about "bacterial gene regulation"
...
As the latter type of regulation is the focus of this this work, I outline the important aspects of this process in more detail below.
...
% 17.9.2018
% I would almost flip this whole sectiobn up top, after Transcriptional Networks, as this is more general - topology - followed by specific examples. Or you could name specific examples and mechanisms after mentioning each type of topoology.
...
The speed of response is affected by the type of transcriptional circuitry that controls it (Fig.~\ref{motifs}).
Negative feedback loop decreases the response time \cite{rosenfeld2002negative}.
...
Positive autoregulation (Fig.~\ref{motifs}\textcolor{red}{b}) exhibits the opposite traits.
...
Moreover, both graded and hysteretic expression can occur in positively autoregulated genes \cite{maeda2006regulatory}.
...
Feed forward loops (FFLs) are also common regulatory motifs.
...
FFL is a regulatory circuit when a transcription factor X regulates another transcription factor, Y, and both (X and Y) regulate a gene or operon Z (Fig.~\ref{motifs}\textcolor{red}{c} and \textcolor{red}{d}).
% 17.9.2018
% in general you could place REFs a little earlier than you do, and perhaps use a few more.
There is further distinction between coherent and incoherent FFL.
% 17.9.2018
% I think you first need to say something about how this affects the response, as you did above - slow, fast, noisy, etc.
...
The AND-FFL delays full gene expression compared to non-FFL system \cite{mangan2003coherent}, while no delay was observed in the inverse (ON to OFF) transition.
% 17.9.2018
% "was used" - and in general use less passive and more active voice, although this is up to you really...
...
Another nice example of a long-term epigenetic switch mediated by a positive feedback loop was published recently.
