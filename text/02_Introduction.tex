...
So as to fit the whole genetic information into a cell, bacterial chromosomes are folded by associated proteins (NAPs) creating compact nucleoids.
However NAPs' role in cell processes such as replication, horizontal gene transfer or transcription regulation was shown as well.
...
H-NS is considered the principal nucleoid-associated protein due to its abundance and occurrence at all growth phases.
Its expression is negatively autoregulated, but another NAP Fis acts as an activator of \tax{hns} gene.
H-NS binds AT-rich DNA regions and forms polymers bridging distant DNA sequences.
This leads to promoter silencing especially in cases when $\alpha$ subunit of RNA polymerase uses AT-rich sites to stabilize binding of the whole complex to the promoter.
However H-NS can compete with RNA polymerase and other transcriptional factors binding in general.
RNA polymerase might get even stuck in a DNA loop unable to elongate mRNA.
Creation of such loops is the outcome of H-NS polymerization.
H-NS silencing of affected promoters is not strict though as RNA polymerase sometimes bypasses this by association with an alternative $\sigma$ factors instead of conventional $\sigma^{70}$.
%%% Add references!!!
...
Nice example of HU versatility in this context is a bacterium \tax{Mycoplasma genitalium} which lacks transcription factors and all gene expression is regulated by the only NAP it has - HU and DNA supercoiling (whose role is mentioned further).
%%% Add references!!!


%%% Add references!!!

%%% Mention DNA supercoiling in the end of this (subsub)section!!!
