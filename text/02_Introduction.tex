...
Naturally it faces recurrent transitions between mammalian gastrointestinal tract (GIT) and outside environment.
In GIT the temperature is usually higher than outside and oxygen is limited.
However, during the transition from mammalian host the surrounding temperature decreases and oxygen levels rise.
Consistent with predictive behaviour \tax{E. coli} strongly represses genes responsible for aerobic metabolism when cultivation temperature increases from 25$^{\circ}$C to 37$^{\circ}$C (without change in oxygen levels) in laboratory conditions \cite{tagkopoulos2008predictive}.
While if the temperature drops correlation in up-regulation of aerobic metabolism genes occurs.
Without the host-environment transition context this behaviour might seem maladaptive.
So they also evolved this strain in conditions where increase in temperature was followed by oxygen saturation and after temperature decreased anaerobic conditions were established.
After 1000 generations a substantial increase in fitness of evolved lines compared to ancestor is observed in such conditions.
Besides, decrease in correlation between global transcriptional responses to temperature upshift and oxygen upshift in evolved strain is described.
