...
%%% want to add some comment about me focusing to transcriptional regulation and mention that regulation at other levels (translation, protein activity) occur as well
...
%%% i'm going to change the picture a bit, showing that ArgR doesn't affect only one promoter...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.4]{text/Pictures/DirectSignaling.png}
...
%%% I know, I'll change the picture later...
\begin{figure}[t!]
  \centering
