...
However, it is still not completely understood how natural selection shape particular cell mechanisms and behaviours.
This work aims to get a better view on the role natural selection plays in transcriptional responses and memory in five bacterial transcriptional networks.
...
To begin with, we used the well-studied \textit{lacZ} and \textit{recA} promoters to establish the main workflows.
...
This study brings a new way of studying the role of natural selection on behavioural responses of bacteria, as previous works focused mainly on lab strains.
Here we use a collection of environmental \textit{E.~coli} isolates to look into how natural selection has acted really in nature.
}
