...
Preliminary results show that both the promoter sequence and genetic background affect the promoter activity, which means that both cis- and trans-effects play a role in expression driven by a particular promoter.
